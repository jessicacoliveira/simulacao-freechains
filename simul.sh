...
do
    ...
    if (( i % 1 == 0 )) && [[ $(getUserReps "$PIONEIRO_PUBKEY") -gt 0 ]];  then
        tipo="OK"
    ...
    if (( i % 2 == 0 )) && [[ $(getUserReps "$TROLL_PUBKEY") -gt 0 ]];  then
        tipo="OK"
   ...
   if (( i % 2 == 0 )) && [[ $(getUserReps "$ATIVO_PUBKEY") -gt 0 ]];  then
       tipo="OK"
   ...
   if (( i % 6 == 0 )) && [[ $(getUserReps "$NOVATO_PUBKEY") -gt 0 ]];  then
       tipo="OK"
...
do
   ...
   if (( i % 4 == 0 )) && [[ $(getUserReps "$NOVATO_PUBKEY") -gt 0 ]];  then
       tipo="OK"
	HASH=$(pickAndPost "$tipo" "$NOVATO_PORTA" "$NOVATO_PVTKEY")
	synchronizeUsers > /dev/null
	if isInHeads "$HASH" "$NOVATO_PORTA"; then
...
do
   ...
   if (( i % 2 == 0 )) && [[ $(getUserReps "$NOVATO_PUBKEY") -gt 0 ]];  then
       tipo="OK"
	HASH=$(pickAndPost "$tipo" "$NOVATO_PORTA" "$NOVATO_PVTKEY")
	synchronizeUsers > /dev/null
	if isInHeads "$HASH" "$NOVATO_PORTA"; then
